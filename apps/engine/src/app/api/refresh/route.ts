 ...
 *   - Vercel cron (vercel.json "crons" config, schedule e.g. every 15 min)
 *   - Railway / Render cron — via external HTTP trigger
 *   - Next.js instrumentation.ts setInterval (self-hosted)
 *   - Manual curl for testing: POST /api/refresh
 *
